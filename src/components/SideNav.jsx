  ...
  return (
    <>
        ...
        >
          ...
          <ul className='scrollbar-thin overflow-y-auto h-full mt-[72px] p-2 text-lg'>
            ...
            <li className='flex items-center px-4 mb-2 rounded-lg hover:bg-lightGray h-14 dark:hover:bg-darkModeGray'>
              ...
              <span className='mt-1 text-base text-center'>YouTube Music</span>
            </li>
            ...
            <li className='flex items-center px-4 mb-2 rounded-lg hover:bg-lightGray h-14 dark:hover:bg-darkModeGray'>
              ...
              <span className='mt-1 text-base text-center'>오프라인 저장</span>
            </li>
          </ul>
        </section>
      </>
      ...
      {location.pathname !== '/watch' && (
        <>
          <section className='fixed z-10 hidden w-20 h-screen mt-[4.5rem] bg-white dark:bg-bgBlack sm:block lg:w-56 scrollbar-thin hover:overflow-y-auto'>
